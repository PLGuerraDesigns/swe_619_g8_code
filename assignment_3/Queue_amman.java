...
public class Queue<E> {
   ...
   * 3. Make the class final so it can't be extended, or make all the getters
  ...
  // 1. should the copy be an instance variable? bc if we have to enqueue multiple
  // times...
  // 2. should we make an accessor that copies the current arraylist and then adds
  // to that (seems like prof wants this one?)
  ...
  /*
   * Steps 1, 3, and 4: Split enQueue method into an observer and producer. This
   * gets rid of the mutator.
   * The observer/getter will be made final to prevent overriding, and defensive
   * copying will be used to
  ...
  /*
   * Step 3: Make Observer/Accessor/Getter final to prevent modifications. Use
   * defensive copying to protect original
   */
